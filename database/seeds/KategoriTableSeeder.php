...
class KategoriTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $id = DB::table('kategori')->insertGetId(['kategori_adi' => 'Elektronik', 'slug'=> 'elektronil']);
        ...
        DB::table('kategori')->insert(['kategori_adi' => 'Sinavlara Hazirlik', 'slug'=> 'sinavrala-hazirliq', 'ust_id' => $id]);
