...
class AnasayfaController extends Controller
{
    public function index()
    {
        ...
        $urunler_one_cinak = Urun::select('urun.*')
            ->join('urun_detay', 'urun_detay.urun_id', 'urun.id')
        ...
        return view('anasayfa', compact('kategoriler', 'urunler_slider', 'urun_gunun_firsati', 'urunler_one_cinak', 'urunler_cok_satan', 'urunler_indirimli'));
    }
}
