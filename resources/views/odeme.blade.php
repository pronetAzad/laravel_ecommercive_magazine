                ...
                <div class="col-md-5">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                Yıl
                                <select id="son_kullanma_tarihi_ay" name="son_kullanma_tarihi_yil" class="form-control" required>
                                    <option>2018</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control telefon" name="ceptelefon" id="ceptelefon" value="{{ $kullanici_detay->ceptelefonu }}" required>
                            </div>
                        </div>
                    </div>
                </div>
