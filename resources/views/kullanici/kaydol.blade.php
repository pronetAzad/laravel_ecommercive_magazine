                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('kullanici.kaydol')  }}">
                            {{ csrf_field() }}
                            <div class="form-group {{ $errors->has('adsoyad') ? 'form-group has-error has-feedback' : ''}}">
                            ...
                            <div class="form-group {{ $errors->has('email') ? 'form-group has-error has-feedback' : ''}}">
                            ...
                            <div class="form-group {{ $errors->has('sifre') ? 'form-group has-error has-feedback' : ''}}">
                            ...
                            <div class="form-group">
                                <label for="sifre-terkarari" class="col-md-4 control-label">Şifre (Tekrar)</label>
                                <div class="col-md-6">
                                    <input id="sifre-terkarari" type="password" class="form-control" name="sifre_confirmation" required>
                                </div>
                            </div>
