                    ...
                    <div class="list-group categories">
                        @foreach($kategoriler as $value)
                            <a href="{{ route('kategori', $value->slug) }}" class="list-group-item">
                                <i class="fa fa-arrow-circle-o-right"></i> {{$value->kategori_adi}}</a>
                        @endforeach
                    </div>
                </div>
            </div>
                    ...
                    <div class="carousel-inner" role="listbox">
                        @foreach($urunler_slider as $index => $urun)
                            <div class="item {{ $index == 0 ? 'active' : '' }}">
                                <img src="img/menu1.jpg" alt="..." width="560">
                ...
                <div class="panel panel-default" id="sidebar-product">
                    ...
                    <div class="panel-body">
                        <a href="{{ route('urun', $urun_gunun_firsati->slug)  }}">
                            ...
                            'http://via.placeholder.com/400x485?text=UrunResmi'
                            }}"
    ...
    <div class="container">
        <div class="products">
            <div class="panel panel-theme">
                ...
                <div class="panel-body">
                    <div class="row">
                        @foreach($urunler_one_cinak as $urun)
